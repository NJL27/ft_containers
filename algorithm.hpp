...
namespace ft{
	...
	template <class InputIt1, class InputIt2, class BinaryPredicate>						
	bool equal(InputIt1 first1, InputIt1 last1, InputIt2 first2, BinaryPredicate pred){		//algorithm line 1324
	...
	template <class InputIt1, class InputIt2>												
	bool equal(InputIt1 first1, InputIt1 last1, InputIt2 first2){							//algorithm line 1335
		while (first1 != last1){															//cplusplus / cppreference
	...
	template <class Compare, class InputIt1, class InputIt2>														
	bool lexicographical_compare(InputIt1 first1, InputIt1 last1,							//algorithm line 5671
	...
	template <class InputIt1, class InputIt2>												
	bool lexicographical_compare(InputIt1 first1, InputIt1 last1,							//algorithm line 5703
...
// #ifndef _LIBCPP_ALGORITHM	NEEDS TO BE COMMENTED IN
// #define _LIBCPP_ALGORITHM	NEEDS TO BE COMMENTED IN
...
//EVERYTHING BELOW NEEDS TO BE COMMENTED IN & EVERYTHIGN ABOVE COMMENTED OUT
